...
if __name__ == "__main__":
    src_dir = r"E:\DataSets\edge_crack\cut_patches"
    assert os.path.isdir(src_dir), f"Error src_dir:{src_dir} incorrect!!"

    dst_dir = createDir(r"E:\DataSets\edge_crack\paddlecls_split")
    train_percent = 80
